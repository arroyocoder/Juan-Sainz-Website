...
const BannerLanding = (props) => (<section id="banner" className="">
  <div className="inner">
    <header className="major">
      <h1 className="banner-text">FLAMENCO&#x266D;</h1>
    </header>
    <div className="content">
      <p className="banner-text">
        ...
        ,
        <a href="https://flamencoagency.com/es/sergiomonroy-2/" target="blank" className="anchor-jazz-three">&nbsp;SERGIO MONROY</a>,
        <a href="https://guitarraespañola.net/juani-de-la-isla/" target="blank" className="anchor-jazz-three">&nbsp;JUANI DE LA ISLA</a>,
        <a href="https://www.deflamenco.com/revista/cante/pedro-el-granaino-3.html" target="blank" className="anchor-jazz-three">&nbsp;PEDRO EL GRANAÍNO</a>,
        <a href="https://www.deflamenco.com/revista/entrevistas/enrique-bermudez-piculabe-cantaor-1.html" target="blank" className="anchor-jazz-three">&nbsp;PICULABE</a>,
        <a href="https://es.wikipedia.org/wiki/Pansequito" target="blank" className="anchor-jazz-three">&nbsp;PANSEQUITO</a>,
        ...
      </p>
    </div>
  </div>
