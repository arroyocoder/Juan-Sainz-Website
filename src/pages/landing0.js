...
<iframe width="100%" height="400" src="https://www.youtube.com/embed/LNHG8t9Ao20" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <div className="content landing-generic-color">
          <div className="inner">
            <header className="major">
      ...
      <section>
<iframe width="100%" height="440" src="https://www.youtube.com/embed/jUUjFCASZBs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        <div className="content landing-generic-color">
          <div className="inner">
            <header className="major">
              <h3>La Canalla</h3>
            </header>
            <p className="text-shade-3">Formado por cinco andaluces practicantes y un alma netamente gaditana, el grupo se crea circunstancialmente allá por 2009 en Barcelona. Juan fue miembro fundador del grupo, grabó el primer Cd
              <a href="" className="anchor-jazz-two" target="blank">&nbsp;“Flores y Malas Yerbas”,&nbsp;</a>
              trabajando junto a
              <a href="" className="anchor-jazz-two" target="blank">&nbsp;Muchachito Bombo Infierno&nbsp;</a>,
              <a href="" className="anchor-jazz-two" target="blank">&nbsp;Tony Zenet&nbsp;</a>,
              <a href="" className="anchor-jazz-two" target="blank">&nbsp;Javier Ruibal&nbsp;</a>,etc.
              <br/>
      ...
      <section>
<iframe width="100%" height="420" src="https://www.youtube.com/embed/TE4S2zv2J3w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        <div className="content landing-generic-color">
          <div className="inner">
            <header className="major">
